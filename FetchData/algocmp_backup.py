...
ave_precision = {}
ave_accuracy = {}
fold_svcf1scores_tuple = ()
fold_svcrecall_tuple = ()
fold_svcprecision_tuple = ()
fold_svcaccuracy_tuple = ()

fold_logregf1scores_tuple = ()
fold_logregrecall_tuple = ()
fold_logregprecision_tuple = ()
fold_logregaccuracy_tuple = ()

fold_nbf1scores_tuple = ()
fold_nbrecall_tuple = ()
fold_nbprecision_tuple = ()
fold_nbaccuracy_tuple = ()
...
#             ave_accuracy[key_name] = accuracy_score(test[category], nb_prediction)
    ...
    fold_logregf1scores = fold_logregf1scores/len(categories)
    fold_nbf1scores = fold_nbf1scores/len(categories)

    fold_svcf1scores_tuple += (fold_svcf1scores,)
    fold_logregf1scores_tuple = fold_logregf1scores_tuple + (fold_logregf1scores,)
    fold_nbf1scores_tuple += (fold_nbf1scores,)
fscore_df = pd.DataFrame(data=[fold_svcf1scores_tuple, fold_logregf1scores_tuple, fold_nbf1scores_tuple], 
                    index=['Fold1', 'Fold2'],
                    columns=['SVM', 'LR', 'NB']) 
...
ax.axis('off')
table(ax, fscore_df, loc='center', colWidths=[0.17]*len(fscore_df.columns))  # where df is your data frame

# plt.savefig('./scores/fscore_perfold' + category +'.png')
...
# plt.tight_layout()
# plt.savefig('./scores/avefscores.png')