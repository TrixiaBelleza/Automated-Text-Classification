...
for category in categories:
    ...
    df_results = np.array([['','Recall','Precision', 'F-score', 'Accuracy'],
                ['SVC',recall_score(test[category], svc_prediction, average='macro'), precision_score(test[category], svc_prediction, average='macro'), f1_score(test[category], svc_prediction, average='macro'), accuracy_score(test[category], svc_prediction)],
                ['LogisticRegression',recall_score(test[category], logreg_prediction, average='macro'), precision_score(test[category], logreg_prediction, average='macro'), f1_score(test[category], logreg_prediction, average='macro'), accuracy_score(test[category], logreg_prediction)],
                ['NaiveBayes',recall_score(test[category], nb_prediction, average='macro'), precision_score(test[category], nb_prediction, average='macro'), f1_score(test[category], nb_prediction, average='macro'), accuracy_score(test[category], nb_prediction)]])
